...
jQuery(function ($) {
    ...
    function ThemeToggle() {
        var storageKey = 'kopex-theme';
        var $toggle = jQuery('.bringer-theme-toggle');
        if ( !$toggle.length ) {
            return;
        }
        var saved = null;
        ...
        if ( saved === 'dark' ) {
            core.$dom.body.removeClass('theme-light');
        } else {
            core.$dom.body.addClass('theme-light');
        }
        $toggle.on('click', function() {
            core.$dom.body.toggleClass('theme-light');
            var mode = core.$dom.body.hasClass('theme-light') ? 'light' : 'dark';
            try {
