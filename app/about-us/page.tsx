...
const ABOUT_COPY: Record<Language, {
  ...
  sr: {
    ...
    capacitiesBody: 'Projektovani kapacitet proizvodnje iznosi 3000 t godišnje, uz mogućnost izrade odlivaka do 3 t (nodularni i čelični liv) i do 6 t (sivi liv).',
  ...
  en: {
    ...
    capacitiesBody: 'Planned production capacity is 3000 t per year, with casting capability up to 3 t (ductile and steel) and up to 6 t (gray iron).',
  ...
  de: {
    ...
    capacitiesBody: 'Die geplante Produktionskapazität beträgt 3000 t pro Jahr, mit Guss bis 3 t (Sphäro- und Stahlguss) und bis 6 t (Grauguss).',
