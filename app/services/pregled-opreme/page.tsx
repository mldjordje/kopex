...
const EQUIPMENT_COPY_SR: EquipmentCopy = {
  ...
  equipmentItems: [
    ...
    'Mašine za Alphacet postupak',
    'Vibracioni stolovi',
    'Peskirnice (metalnom sačmom), dimenzija 2200x1900x2500 mm, kapaciteta 15 tona',
    'Peći za termičku obradu kapaciteta 10 tona (2100x1400x3500 mm) i 6 tona',
    'Bazeni za gašenje i kaljenje dimenzija 4000x3000x4000 mm',
    'Proizvodni kapacitet 100 tona liva mesečno (projektovani kapacitet 1000 tona liva mesečno)',
    'Kaluparnica',
